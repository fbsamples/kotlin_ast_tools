...
/** Tests [APackageDirective] */
class APackageDirectiveTest {

  @Test
  fun `basic functionality`() {
    val aElementsTestUtil =
        AElementTestingUtil<APackageDirective, PsiPackageStatement, KtPackageDirective>()

    val (javaElement, kotlinElement) =
        aElementsTestUtil.loadTestAElements<APackageDirective>(
            javaCode =
                """
